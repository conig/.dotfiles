#!/home/conig/.local/venvs/i3statusenv/bin/python3
# activate python instance
# source /home/conig/.local/venvs/i3statusenv/bin/activate
import time
import os
import re
import requests
...
def main():
    ...
    if event:
        ...
        if(delta_minutes < 480):
            if(delta_minutes < 60):
                print(f"{meeting_name} ~{delta_minutes}m")
            else:
